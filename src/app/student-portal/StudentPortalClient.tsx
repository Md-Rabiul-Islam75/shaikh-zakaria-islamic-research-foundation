              ...
              {canModify && (
                <div className="absolute top-3 right-3 flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                  <button
                    ...
                    className="w-8 h-8 bg-white/20 hover:bg-white/30 backdrop-blur rounded-lg flex items-center justify-center"
                    title="Edit class"
                  >
                  ...
                  <button
                    ...
                    className="w-8 h-8 bg-white/20 hover:bg-red-500/80 backdrop-blur rounded-lg flex items-center justify-center"
                    title="Delete class"
                  >
                    <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
